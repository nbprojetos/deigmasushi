<div class="pedidos index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('fechado'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($pedido['Pedido']['data']); ?>&nbsp;</td>
		...
		<td><?php echo h($pedido['Pedido']['ocupacao']); ?>&nbsp;</td>
		<td><?php echo h($pedido['Pedido']['fechado']); ?>&nbsp;</td>
		<td class="actions">
